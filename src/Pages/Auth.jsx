  ...
  return (
    ...
    >
      <div className="mb-2">
        ...
        <input
          className="border py-1 px-2 w-full focus:outline-none"
          {...register("firstName", {
      ...
      <div>
        <input
          type="submit"
          className="py-2 px-4 bg-rose-500 border-stone-950 text-white cursor-pointer"
        />
      </div>
    </form>
  );
